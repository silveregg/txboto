...
class Item(object):
    ...
    def get_keys(self):
        ...
        Largely internal.
        """
        key_fields = yield self.table.get_key_fields()
        key_data = {}

        for key in key_fields:
            key_data[key] = self[key]

        defer.returnValue(key_data)
    ...
    def get_raw_keys(self):
        ...
        defer.returnValue(raw_key_data)
    ...
    def partial_save(self):
        ...
        returned = yield self.table._update_item(key, final_data, expects=expects)
        # Mark the object as clean.
        self.mark_clean()
        defer.returnValue(returned)
    ...
    def save(self, overwrite=False):
        ...
        returned = yield self.table._put_item(final_data, expects=expects)
        # Mark the object as clean.
        self.mark_clean()
        defer.returnValue(returned)
    ...
    def delete(self):
        ...
        """
        key_data = yield self.get_keys()
        ret = yield self.table.delete_item(**key_data)
